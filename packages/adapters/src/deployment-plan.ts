...
export function resolvePlan(bundle: AppBundle, o: PlanOptions): DeploymentPlan {
  ...
  if (o.target === "cloudflare") {
    ...
    resources.push({ id: "api", kind: "aws_lambda_function", name: name("api"), ownership: "managed", bindings: {}, properties: { runtime: "nodejs24.x", handler: "index.handler", memory: 1024, timeout: 30 }, retain: false });
