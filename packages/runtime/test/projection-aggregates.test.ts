...
it("maintains filtered counts, existence and extrema through updates, deletions and rebuild",async()=>{
  const model=new Model(bundle),storage=new MemoryStorage(),engine=new Engine(model,testLayer(storage));
