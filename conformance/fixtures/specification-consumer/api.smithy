...
namespace foundation.probe.specification.consumers
...
structure BroadcastSessionRecord {
    @required
    id: String
    @required
...
structure BroadcastSessionCreateInput {
    @required
    specification: String
}

structure BroadcastSessionPatchInput {
}
...
structure ExperienceSessionRecord {
    @required
    id: String
    @required
    specification: String
...
structure ExperienceSessionCreateInput {
    @required
    specification: String
}

structure ExperienceSessionPatchInput {
}

structure LabExperimentRecord {
    @required
    id: String
    @required
    specification: String
...
structure LabExperimentCreateInput {
    @required
    specification: String
}

structure LabExperimentPatchInput {
}

structure LevelGenerationRecord {
    @required
    id: String
    @required
    specification: String
...
structure LevelGenerationCreateInput {
    @required
    specification: String
}

structure LevelGenerationPatchInput {
}

structure ManufacturingBatchRecord {
    @required
    id: String
    @required
    specification: String
...
structure ManufacturingBatchCreateInput {
    @required
    specification: String
}

structure ManufacturingBatchPatchInput {
}
