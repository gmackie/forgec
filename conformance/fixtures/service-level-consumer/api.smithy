...
namespace fixture.service.level.consumer
...
structure DeploymentObjectiveRecord {
    @required
    id: String
    @required
    deployment: String
...
structure DeploymentObjectiveCreateInput {
    @required
    deployment: String
    @required
    instance: String
...
structure DeploymentObjectivePatchInput {
}

structure LabTurnaroundRecord {
    @required
    id: String
    @required
    sample: String
...
structure LabTurnaroundCreateInput {
    @required
    sample: String
    @required
    instance: String
...
structure LabTurnaroundPatchInput {
}

structure SupportFirstResponseRecord {
    @required
    id: String
    @required
    ticket: String
...
structure SupportFirstResponseCreateInput {
    @required
    ticket: String
    @required
    instance: String
...
structure SupportFirstResponsePatchInput {
}
