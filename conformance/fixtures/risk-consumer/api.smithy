...
namespace fixture.risk.consumer
...
structure ProjectRiskCreateInput {
    @required
    risk: String
    @required
    project: String
...
structure ProjectRiskPatchInput {
}

structure SecurityRiskRecord {
    @required
    id: String
    @required
    risk: String
...
structure SecurityRiskCreateInput {
    @required
    risk: String
    @required
    threat: String
...
structure SecurityRiskPatchInput {
}

structure VendorRiskRecord {
    @required
    id: String
    @required
    risk: String
...
structure VendorRiskCreateInput {
    @required
    risk: String
    @required
    vendor: String
...
structure VendorRiskPatchInput {
}
