...
namespace fixture.evaluation.consumer
...
structure ChangeVerificationRecord {
    @required
    id: String
    @required
    run: String
...
structure ChangeVerificationCreateInput {
    @required
    run: String
    @required
    commit: String
...
structure ChangeVerificationPatchInput {
}

structure InspectionRecord {
    @required
    id: String
    @required
    run: String
...
structure InspectionCreateInput {
    @required
    run: String
    @required
    lot: String
...
structure InspectionPatchInput {
}

structure LanguageModelEvaluationRecord {
    @required
    id: String
    @required
    run: String
...
structure LanguageModelEvaluationCreateInput {
    @required
    run: String
    @required
    modelRevision: String
...
structure LanguageModelEvaluationPatchInput {
}

structure LevelEvaluationRecord {
    @required
    id: String
    @required
    run: String
...
structure LevelEvaluationCreateInput {
    @required
    run: String
    @required
    candidate: String
...
structure LevelEvaluationPatchInput {
}
