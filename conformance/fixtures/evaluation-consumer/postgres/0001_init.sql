...
CREATE TABLE inspection (
  ...
  "acceptable" BIGINT NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "run") REFERENCES evaluation_run ("tenant", "id")
);

CREATE TABLE language_model_evaluation (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "run" TEXT COLLATE "C" NOT NULL,
  "model_revision" TEXT COLLATE "C" NOT NULL,
  "dataset_revision" TEXT COLLATE "C" NOT NULL,
  "accuracy" BIGINT NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "run") REFERENCES evaluation_run ("tenant", "id")
);

CREATE TABLE level_evaluation (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "run" TEXT COLLATE "C" NOT NULL,
...
CREATE UNIQUE INDEX change_verification_uq_run ON change_verification ("tenant", "run");
CREATE UNIQUE INDEX inspection_uq_run ON inspection ("tenant", "run");
CREATE UNIQUE INDEX language_model_evaluation_uq_run ON language_model_evaluation ("tenant", "run");
CREATE UNIQUE INDEX level_evaluation_uq_run ON level_evaluation ("tenant", "run");
