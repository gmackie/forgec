...
namespace fixture.project.consumer
...
structure CapitalProjectRecord {
    @required
    id: String
    @required
    project: String
...
structure CapitalProjectCreateInput {
    @required
    project: String
    @required
    site: String
...
structure CapitalProjectPatchInput {
}

structure ResearchStudyRecord {
    @required
    id: String
    @required
    project: String
...
structure ResearchStudyCreateInput {
    @required
    project: String
    @required
    protocol: String
...
structure ResearchStudyPatchInput {
}

structure SoftwareProjectRecord {
    @required
    id: String
    @required
    project: String
...
structure SoftwareProjectCreateInput {
    @required
    project: String
    @required
    repository: String
...
structure SoftwareProjectPatchInput {
}
...
structure ProjectPatchInput {
}

structure ProjectDependencyRecord {
    @required
    id: String
    @required
    project: String
...
structure ProjectDependencyCreateInput {
    @required
    project: String
    @required
    ordinal: Long
...
structure ProjectDependencyPatchInput {
}

structure ProjectMilestoneResultRecord {
    @required
    id: String
    @required
    work: String
...
structure ProjectMilestoneResultCreateInput {
    @required
    work: String
    @required
    milestone: String
...
structure ProjectMilestoneResultPatchInput {
}

structure WorkPackageRecord {
    @required
    id: String
    @required
    project: String
...
structure WorkPackageCreateInput {
    @required
    project: String
    @required
    ordinal: Long
...
structure WorkPackagePatchInput {
}
