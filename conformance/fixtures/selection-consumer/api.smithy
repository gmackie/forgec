...
namespace foundation.probe.selection.consumers
...
structure GrantApplicationRecord {
    @required
    id: String
    @required
    submission: String
...
structure GrantApplicationCreateInput {
    @required
    submission: String
    @required
    programCode: String
...
structure GrantApplicationPatchInput {
    submission: String
    programCode: String
}

structure JobApplicationRecord {
    @required
    id: String
    @required
    submission: String
...
structure JobApplicationCreateInput {
    @required
    submission: String
    @required
    applicationCode: String
...
structure JobApplicationPatchInput {
    submission: String
    applicationCode: String
}

structure ProcurementBidRecord {
    @required
    id: String
    @required
    submission: String
...
structure ProcurementBidCreateInput {
    @required
    submission: String
    @required
    tenderCode: String
...
structure ProcurementBidPatchInput {
    submission: String
    tenderCode: String
}
