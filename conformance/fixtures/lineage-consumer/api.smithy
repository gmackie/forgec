...
namespace fixture.lineage.consumer
...
structure BuildExecutionRecord {
    @required
    id: String
    @required
...
structure BuildExecutionCreateInput {
    @required
    transformation: String
    @required
    build: String
...
structure BuildExecutionPatchInput {
}

structure DatasetTransformRecord {
    @required
    id: String
    @required
    transformation: String
...
structure DatasetTransformCreateInput {
    @required
    transformation: String
    @required
    recipe: String
...
structure DatasetTransformPatchInput {
}
...
structure SoftwareBuildCreateInput {
    @required
    provenance: String
    @required
    commit: String
...
structure SoftwareBuildPatchInput {
}
