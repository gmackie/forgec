...
namespace fixture.planning.consumer
...
structure CapacityPlanCreateInput {
    @required
    plan: String
    @required
    label: String
...
structure CapacityPlanPatchInput {
}

structure ProcurementBudgetRecord {
    @required
    id: String
    @required
    plan: String
...
structure ProcurementBudgetCreateInput {
    @required
    plan: String
    @required
    label: String
...
structure ProcurementBudgetPatchInput {
}

structure ProjectPlanRecord {
    @required
    id: String
    @required
    plan: String
...
structure ProjectPlanCreateInput {
    @required
    plan: String
    @required
    label: String
...
structure ProjectPlanPatchInput {
}
