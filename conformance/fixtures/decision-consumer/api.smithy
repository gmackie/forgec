...
structure HumanApprovalCreateInput {
    @required
    subject: String
    @required
    decisionCase: String
...
structure HumanApprovalPatchInput {
}

structure ReleaseGateRecord {
    @required
    id: String
    @required
    releaseKey: String
...
structure ReleaseGateCreateInput {
    @required
    releaseKey: String
    @required
    decisionCase: String
...
structure ReleaseGatePatchInput {
}

structure ReviewBoardDecisionRecord {
    @required
    id: String
    @required
    reviewKey: String
...
structure ReviewBoardDecisionCreateInput {
    @required
    reviewKey: String
    @required
    decisionCase: String
...
structure ReviewBoardDecisionPatchInput {
}
