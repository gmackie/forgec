...
CREATE TABLE review_board_decision (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
...
ALTER TABLE human_approval ADD FOREIGN KEY ("tenant", "decision_case") REFERENCES decision_case ("tenant", "id");

ALTER TABLE release_gate ADD FOREIGN KEY ("tenant", "decision_case") REFERENCES decision_case ("tenant", "id");

ALTER TABLE review_board_decision ADD FOREIGN KEY ("tenant", "decision_case") REFERENCES decision_case ("tenant", "id");
