...
CREATE TABLE bob_runner (
  ...
  "runner_key" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
...
CREATE TABLE lab_request (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "assay" TEXT COLLATE "C" NOT NULL,
  "requested_samples" BIGINT NOT NULL,
  "runs" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "runs") REFERENCES fulfillment_set ("tenant", "id")
);
...
CREATE TABLE provisioning_request (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "workspace_name" TEXT COLLATE "C" NOT NULL,
  "runs" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "runs") REFERENCES fulfillment_set ("tenant", "id")
);
...
CREATE TABLE lab_outcome (
  ...
  "request" TEXT COLLATE "C" NOT NULL,
  "execution" TEXT COLLATE "C" NOT NULL,
  "processed_samples" BIGINT NOT NULL,
  "report_code" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
...
CREATE TABLE provisioning_outcome (
  ...
  "request" TEXT COLLATE "C" NOT NULL,
  "execution" TEXT COLLATE "C" NOT NULL,
  "provisioned_endpoint" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
