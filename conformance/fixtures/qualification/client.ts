// Generated by forgec build from @forgegraph/foundation/qualification (contracts/1). Do not edit.
...
export const operations: Record<string, OperationSpec> = {
  ...
  "@forgegraph/foundation/qualification/_/changesets.propose": { method: "POST", path: "/v1/changesets", kind: "changeset.propose", resource: "changesets" },
  "@forgegraph/foundation/qualification/_/changesets.get": { method: "GET", path: "/v1/changesets/{id}", kind: "changeset.get", resource: "changesets" },
  "@forgegraph/foundation/qualification/_/changesets.preview": { method: "GET", path: "/v1/changesets/{id}/preview", kind: "changeset.preview", resource: "changesets" },
  "@forgegraph/foundation/qualification/_/changesets.approve": { method: "POST", path: "/v1/changesets/{id}/approve", kind: "changeset.approve", resource: "changesets" },
  "@forgegraph/foundation/qualification/_/changesets.commit": { method: "POST", path: "/v1/changesets/{id}/commit", kind: "changeset.commit", resource: "changesets" },
  "@forgegraph/foundation/qualification/_/admin.export": { method: "POST", path: "/v1/admin/export", kind: "admin.export", resource: "admin" },
  "@forgegraph/foundation/qualification/_/admin.import": { method: "POST", path: "/v1/admin/import", kind: "admin.import", resource: "admin" },
  "@forgegraph/foundation/qualification/_/admin.verify": { method: "POST", path: "/v1/admin/verify", kind: "admin.verify", resource: "admin" },
  "@forgegraph/foundation/qualification/_/admin.fence": { method: "POST", path: "/v1/admin/fence", kind: "admin.fence", resource: "admin" },
  "@forgegraph/foundation/qualification/_/admin.inspect": { method: "POST", path: "/v1/admin/inspect", kind: "admin.inspect", resource: "admin" },
  "@forgegraph/foundation/qualification/_/admin.subjects.locate": { method: "POST", path: "/v1/admin/subjects/locate", kind: "admin.subjects.locate", resource: "admin" },
  "@forgegraph/foundation/qualification/_/imports.inspect": { method: "POST", path: "/v1/imports/inspect", kind: "import.inspect", resource: "imports" },
  "@forgegraph/foundation/qualification/_/imports.stage": { method: "POST", path: "/v1/imports/stage", kind: "import.stage", resource: "imports" },
};
...
export function createClient(options: ClientOptions): ForgeClient {
  ...
  return {
    call: t.call,
    changesets: {
      propose: (input, opts) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/changesets.propose", input, opts)),
      get: (id) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/changesets.get", { id })),
      preview: (id) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/changesets.preview", { id })),
      approve: (id, contentHash) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/changesets.approve", { id, contentHash })),
      commit: (id, opts) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/changesets.commit", { id }, opts)),
    },
    functions: {
    },
    imports: {
      inspect: (input) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/imports.inspect", input)),
      stage: (input) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/imports.stage", input)),
    },
    admin: {
      export: () => t.unwrap(t.call("@forgegraph/foundation/qualification/_/admin.export", {})),
      import: (snapshot) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/admin.import", { snapshot })),
      verify: (snapshot) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/admin.verify", { snapshot })),
      fence: (on) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/admin.fence", { on })),
      locateSubject: (input) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/admin.subjects.locate", input)),
      inspect: (input) => t.unwrap(t.call("@forgegraph/foundation/qualification/_/admin.inspect", input)),
    },
    views: {
    },
    projections: {
