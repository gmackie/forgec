// Generated by forgec build from @acme/commerce (contracts/1). Do not edit.
...
export const operations: Record<string, OperationSpec> = {
  ...
  "@acme/commerce/_/admin.export": { method: "POST", path: "/v1/admin/export", kind: "admin.export", resource: "admin" },
  "@acme/commerce/_/admin.import": { method: "POST", path: "/v1/admin/import", kind: "admin.import", resource: "admin" },
  "@acme/commerce/_/admin.verify": { method: "POST", path: "/v1/admin/verify", kind: "admin.verify", resource: "admin" },
  "@acme/commerce/_/admin.fence": { method: "POST", path: "/v1/admin/fence", kind: "admin.fence", resource: "admin" },
  "@acme/commerce/_/admin.inspect": { method: "POST", path: "/v1/admin/inspect", kind: "admin.inspect", resource: "admin" },
  "@acme/commerce/_/admin.subjects.locate": { method: "POST", path: "/v1/admin/subjects/locate", kind: "admin.subjects.locate", resource: "admin" },
...
export function createClient(options: ClientOptions): ForgeClient {
  ...
  return {
    ...
    admin: {
      export: () => t.unwrap(t.call("@acme/commerce/_/admin.export", {})),
      import: (snapshot) => t.unwrap(t.call("@acme/commerce/_/admin.import", { snapshot })),
      verify: (snapshot) => t.unwrap(t.call("@acme/commerce/_/admin.verify", { snapshot })),
      fence: (on) => t.unwrap(t.call("@acme/commerce/_/admin.fence", { on })),
      locateSubject: (input) => t.unwrap(t.call("@acme/commerce/_/admin.subjects.locate", input)),
      inspect: (input) => t.unwrap(t.call("@acme/commerce/_/admin.inspect", input)),
    },
    views: {
