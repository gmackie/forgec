...
CREATE TABLE file_export_destination (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "destination" TEXT COLLATE "C" NOT NULL,
...
ALTER TABLE email_content ADD FOREIGN KEY ("tenant", "intent") REFERENCES delivery_intent ("tenant", "id");

ALTER TABLE file_export ADD FOREIGN KEY ("tenant", "intent") REFERENCES delivery_intent ("tenant", "id");

ALTER TABLE webhook_content ADD FOREIGN KEY ("tenant", "intent") REFERENCES delivery_intent ("tenant", "id");
...
CREATE UNIQUE INDEX email_content_uq_intent ON email_content ("tenant", "intent");
CREATE UNIQUE INDEX email_destination_uq_destination ON email_destination ("tenant", "destination");
CREATE UNIQUE INDEX file_export_uq_intent ON file_export ("tenant", "intent");
CREATE UNIQUE INDEX file_export_destination_uq_destination ON file_export_destination ("tenant", "destination");
CREATE UNIQUE INDEX webhook_content_uq_intent ON webhook_content ("tenant", "intent");
CREATE UNIQUE INDEX webhook_destination_uq_destination ON webhook_destination ("tenant", "destination");
