...
CREATE TABLE software_seat (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "entitlement" TEXT COLLATE "C" NOT NULL,
  "product" TEXT COLLATE "C" NOT NULL,
  "purchase" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "entitlement") REFERENCES entitlement ("tenant", "id"),
  FOREIGN KEY ("tenant", "purchase") REFERENCES purchase ("tenant", "id")
);
...
CREATE TABLE contractual_duty (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "obligation" TEXT COLLATE "C" NOT NULL,
  "contract_number" TEXT COLLATE "C" NOT NULL,
  "deliverable" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
...
CREATE UNIQUE INDEX contractual_duty_uq_obligation ON contractual_duty ("tenant", "obligation");
CREATE UNIQUE INDEX course_access_uq_entitlement ON course_access ("tenant", "entitlement");
CREATE UNIQUE INDEX software_seat_uq_entitlement ON software_seat ("tenant", "entitlement");
CREATE UNIQUE INDEX warranty_coverage_uq_entitlement ON warranty_coverage ("tenant", "entitlement");
