// Generated by forgec build from @example/entitlement (contracts/1). Do not edit.
...
export const operations: Record<string, OperationSpec> = {
  "@example/entitlement/_/changesets.propose": { method: "POST", path: "/v1/changesets", kind: "changeset.propose", resource: "changesets" },
  "@example/entitlement/_/changesets.get": { method: "GET", path: "/v1/changesets/{id}", kind: "changeset.get", resource: "changesets" },
  "@example/entitlement/_/changesets.preview": { method: "GET", path: "/v1/changesets/{id}/preview", kind: "changeset.preview", resource: "changesets" },
  "@example/entitlement/_/changesets.approve": { method: "POST", path: "/v1/changesets/{id}/approve", kind: "changeset.approve", resource: "changesets" },
  "@example/entitlement/_/changesets.commit": { method: "POST", path: "/v1/changesets/{id}/commit", kind: "changeset.commit", resource: "changesets" },
  "@example/entitlement/_/admin.export": { method: "POST", path: "/v1/admin/export", kind: "admin.export", resource: "admin" },
  "@example/entitlement/_/admin.import": { method: "POST", path: "/v1/admin/import", kind: "admin.import", resource: "admin" },
  "@example/entitlement/_/admin.verify": { method: "POST", path: "/v1/admin/verify", kind: "admin.verify", resource: "admin" },
  "@example/entitlement/_/admin.fence": { method: "POST", path: "/v1/admin/fence", kind: "admin.fence", resource: "admin" },
  "@example/entitlement/_/admin.inspect": { method: "POST", path: "/v1/admin/inspect", kind: "admin.inspect", resource: "admin" },
  "@example/entitlement/_/admin.subjects.locate": { method: "POST", path: "/v1/admin/subjects/locate", kind: "admin.subjects.locate", resource: "admin" },
  "@example/entitlement/_/imports.inspect": { method: "POST", path: "/v1/imports/inspect", kind: "import.inspect", resource: "imports" },
  "@example/entitlement/_/imports.stage": { method: "POST", path: "/v1/imports/stage", kind: "import.stage", resource: "imports" },
};

export interface ContractualDutyRecord {
  id: string;
  obligation: string;
...
export interface ContractualDutyCreate {
  obligation: string;
  contractNumber: string;
  deliverable: string;
}

export interface ContractualDutyPatch {
}
...
export interface CourseAccessCreate {
  entitlement: string;
  courseCode: string;
}

export interface CourseAccessPatch {
}
...
export interface SoftwareSeatRecord {
  id: string;
  entitlement: string;
  product: string;
  purchase: string;
...
export interface SoftwareSeatCreate {
  entitlement: string;
  product: string;
  purchase: string;
}

export interface SoftwareSeatPatch {
}
...
export interface WarrantyCoverageCreate {
  entitlement: string;
  serialNumber: string;
  purchase: string;
}

export interface WarrantyCoveragePatch {
}
...
export interface ContractualDutyApi {
}
...
export interface SoftwareSeatApi {
}

export interface WarrantyCoverageApi {
}
...
export interface ForgeClient {
  ...
  imports: ImportsApi;
  admin: AdminApi;
  contractualDutys: ContractualDutyApi;
  courseAccesses: CourseAccessApi;
  purchases: PurchaseApi;
  softwareSeats: SoftwareSeatApi;
  warrantyCoverages: WarrantyCoverageApi;
...
export function createClient(options: ClientOptions): ForgeClient {
  ...
  return {
    call: t.call,
    changesets: {
      propose: (input, opts) => t.unwrap(t.call("@example/entitlement/_/changesets.propose", input, opts)),
      get: (id) => t.unwrap(t.call("@example/entitlement/_/changesets.get", { id })),
      preview: (id) => t.unwrap(t.call("@example/entitlement/_/changesets.preview", { id })),
      approve: (id, contentHash) => t.unwrap(t.call("@example/entitlement/_/changesets.approve", { id, contentHash })),
      commit: (id, opts) => t.unwrap(t.call("@example/entitlement/_/changesets.commit", { id }, opts)),
    },
    functions: {
    },
    imports: {
      inspect: (input) => t.unwrap(t.call("@example/entitlement/_/imports.inspect", input)),
      stage: (input) => t.unwrap(t.call("@example/entitlement/_/imports.stage", input)),
    },
    admin: {
      export: () => t.unwrap(t.call("@example/entitlement/_/admin.export", {})),
      import: (snapshot) => t.unwrap(t.call("@example/entitlement/_/admin.import", { snapshot })),
      verify: (snapshot) => t.unwrap(t.call("@example/entitlement/_/admin.verify", { snapshot })),
      fence: (on) => t.unwrap(t.call("@example/entitlement/_/admin.fence", { on })),
      locateSubject: (input) => t.unwrap(t.call("@example/entitlement/_/admin.subjects.locate", input)),
      inspect: (input) => t.unwrap(t.call("@example/entitlement/_/admin.inspect", input)),
    },
    views: {
    },
    projections: {
