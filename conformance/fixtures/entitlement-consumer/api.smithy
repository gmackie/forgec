...
structure ContractualDutyRecord {
    @required
    id: String
    @required
    obligation: String
...
structure ContractualDutyCreateInput {
    @required
    obligation: String
    @required
    contractNumber: String
...
structure ContractualDutyPatchInput {
}

structure CourseAccessRecord {
    @required
    id: String
    @required
    entitlement: String
...
structure CourseAccessCreateInput {
    @required
    entitlement: String
    @required
    courseCode: String
...
structure CourseAccessPatchInput {
}

structure PurchaseRecord {
    @required
    id: String
    @required
    orderNumber: String
...
structure PurchaseCreateInput {
    @required
    orderNumber: String
}

structure PurchasePatchInput {
}

structure SoftwareSeatRecord {
    @required
    id: String
    @required
    entitlement: String
...
structure SoftwareSeatCreateInput {
    @required
    entitlement: String
    @required
    product: String
...
structure SoftwareSeatPatchInput {
}

structure WarrantyCoverageRecord {
    @required
    id: String
    @required
    entitlement: String
...
structure WarrantyCoverageCreateInput {
    @required
    entitlement: String
    @required
    serialNumber: String
...
structure WarrantyCoveragePatchInput {
}
