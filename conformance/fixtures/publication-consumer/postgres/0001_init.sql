...
CREATE TABLE document_publication (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "document_code" TEXT COLLATE "C" NOT NULL,
...
CREATE TABLE model_release (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "model_revision" TEXT COLLATE "C" NOT NULL,
  "release" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id")
);

CREATE TABLE recipe_publication (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "recipe_code" TEXT COLLATE "C" NOT NULL,
  "release" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id")
);
...
ALTER TABLE document_publication ADD FOREIGN KEY ("tenant", "release") REFERENCES release ("tenant", "id");

ALTER TABLE model_release ADD FOREIGN KEY ("tenant", "release") REFERENCES release ("tenant", "id");

ALTER TABLE recipe_publication ADD FOREIGN KEY ("tenant", "release") REFERENCES release ("tenant", "id");

ALTER TABLE software_release ADD FOREIGN KEY ("tenant", "release") REFERENCES release ("tenant", "id");
