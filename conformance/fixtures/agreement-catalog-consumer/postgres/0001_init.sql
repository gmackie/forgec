...
CREATE TABLE lab_service_order (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "sample_code" TEXT COLLATE "C" NOT NULL,
  "agreement" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id")
);
...
ALTER TABLE course_enrollment ADD FOREIGN KEY ("tenant", "agreement") REFERENCES agreement ("tenant", "id");

ALTER TABLE lab_service_order ADD FOREIGN KEY ("tenant", "agreement") REFERENCES agreement ("tenant", "id");

ALTER TABLE saa_s_subscription ADD FOREIGN KEY ("tenant", "agreement") REFERENCES agreement ("tenant", "id");

ALTER TABLE vendor_contract ADD FOREIGN KEY ("tenant", "agreement") REFERENCES agreement ("tenant", "id");
