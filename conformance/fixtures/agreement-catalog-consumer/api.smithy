...
namespace fixture.agreement.catalog.consumer
...
structure CourseEnrollmentRecord {
    @required
    id: String
    @required
    courseCode: String
...
structure CourseEnrollmentCreateInput {
    @required
    courseCode: String
    @required
    agreement: String
...
structure CourseEnrollmentPatchInput {
}

structure LabServiceOrderRecord {
    @required
    id: String
    @required
    sampleCode: String
...
structure LabServiceOrderCreateInput {
    @required
    sampleCode: String
    @required
    agreement: String
...
structure LabServiceOrderPatchInput {
}
...
structure VendorContractRecord {
    @required
    id: String
    @required
    vendorCode: String
...
structure VendorContractCreateInput {
    @required
    vendorCode: String
    @required
    agreement: String
...
structure VendorContractPatchInput {
}
