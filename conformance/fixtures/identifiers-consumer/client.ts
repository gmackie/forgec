// Generated by forgec build from @foundation-probe/identifier-consumers (contracts/1). Do not edit.
...
export const operations: Record<string, OperationSpec> = {
  "@foundation-probe/identifier-consumers/_/changesets.propose": { method: "POST", path: "/v1/changesets", kind: "changeset.propose", resource: "changesets" },
  "@foundation-probe/identifier-consumers/_/changesets.get": { method: "GET", path: "/v1/changesets/{id}", kind: "changeset.get", resource: "changesets" },
  "@foundation-probe/identifier-consumers/_/changesets.preview": { method: "GET", path: "/v1/changesets/{id}/preview", kind: "changeset.preview", resource: "changesets" },
  "@foundation-probe/identifier-consumers/_/changesets.approve": { method: "POST", path: "/v1/changesets/{id}/approve", kind: "changeset.approve", resource: "changesets" },
  "@foundation-probe/identifier-consumers/_/changesets.commit": { method: "POST", path: "/v1/changesets/{id}/commit", kind: "changeset.commit", resource: "changesets" },
  "@foundation-probe/identifier-consumers/_/admin.export": { method: "POST", path: "/v1/admin/export", kind: "admin.export", resource: "admin" },
  "@foundation-probe/identifier-consumers/_/admin.import": { method: "POST", path: "/v1/admin/import", kind: "admin.import", resource: "admin" },
  "@foundation-probe/identifier-consumers/_/admin.verify": { method: "POST", path: "/v1/admin/verify", kind: "admin.verify", resource: "admin" },
  "@foundation-probe/identifier-consumers/_/admin.fence": { method: "POST", path: "/v1/admin/fence", kind: "admin.fence", resource: "admin" },
  "@foundation-probe/identifier-consumers/_/admin.inspect": { method: "POST", path: "/v1/admin/inspect", kind: "admin.inspect", resource: "admin" },
  "@foundation-probe/identifier-consumers/_/admin.subjects.locate": { method: "POST", path: "/v1/admin/subjects/locate", kind: "admin.subjects.locate", resource: "admin" },
  "@foundation-probe/identifier-consumers/_/imports.inspect": { method: "POST", path: "/v1/imports/inspect", kind: "import.inspect", resource: "imports" },
  "@foundation-probe/identifier-consumers/_/imports.stage": { method: "POST", path: "/v1/imports/stage", kind: "import.stage", resource: "imports" },
};
...
export interface GitHubRepositoryPatch {
  name?: string;
}

export interface HospitalIssuerRecord {
  id: string;
  issuer: string;
  name: string;
}

export interface HospitalIssuerCreate {
  issuer: string;
  name: string;
}

export interface HospitalIssuerPatch {
}

export interface PatientRecordRecord {
  id: string;
  version: number;
...
export interface PatientRecordPatch {
}
...
export interface SerializedDeviceCreate {
  serials: string;
}

export interface SerializedDevicePatch {
}
...
export interface HospitalIssuerApi {
}

export interface PatientRecordApi {
}

export interface SerializedDeviceApi {
}
...
export interface ForgeClient {
  ...
  issuers: IssuerApi;
  gitHubRepositorys: GitHubRepositoryApi;
  hospitalIssuers: HospitalIssuerApi;
  patientRecords: PatientRecordApi;
  serializedDevices: SerializedDeviceApi;
  views: {
  };
  projections: {
  };
...
export function createClient(options: ClientOptions): ForgeClient {
  ...
  return {
    call: t.call,
    changesets: {
      propose: (input, opts) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/changesets.propose", input, opts)),
      get: (id) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/changesets.get", { id })),
      preview: (id) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/changesets.preview", { id })),
      approve: (id, contentHash) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/changesets.approve", { id, contentHash })),
      commit: (id, opts) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/changesets.commit", { id }, opts)),
    },
    functions: {
    },
    imports: {
      inspect: (input) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/imports.inspect", input)),
      stage: (input) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/imports.stage", input)),
    },
    admin: {
      export: () => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/admin.export", {})),
      import: (snapshot) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/admin.import", { snapshot })),
      verify: (snapshot) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/admin.verify", { snapshot })),
      fence: (on) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/admin.fence", { on })),
      locateSubject: (input) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/admin.subjects.locate", input)),
      inspect: (input) => t.unwrap(t.call("@foundation-probe/identifier-consumers/_/admin.inspect", input)),
    },
    views: {
    },
    projections: {
