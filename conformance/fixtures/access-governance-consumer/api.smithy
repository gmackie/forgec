...
namespace fixture.access.governance.consumer
...
structure ServiceAccountAccessRecord {
    @required
    id: String
    @required
    grant: String
...
structure ServiceAccountAccessCreateInput {
    @required
    grant: String
    @required
    workload: String
...
structure ServiceAccountAccessPatchInput {
}

structure TenantAccessRecord {
    @required
    id: String
    @required
    grant: String
...
structure TenantAccessCreateInput {
    @required
    grant: String
    @required
    tenantKey: String
...
structure TenantAccessPatchInput {
}

structure WorkforceAccessRecord {
    @required
    id: String
    @required
    grant: String
...
structure WorkforceAccessCreateInput {
    @required
    grant: String
    @required
    position: String
...
structure WorkforceAccessPatchInput {
}
