...
CREATE TABLE marketplace_resolution_signal (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "signal" TEXT COLLATE "C" NOT NULL,
...
CREATE TABLE vendor_delivery_signal (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "signal" TEXT COLLATE "C" NOT NULL,
...
ALTER TABLE agent_run_signal ADD FOREIGN KEY ("tenant", "signal") REFERENCES trust_signal ("tenant", "id");

ALTER TABLE marketplace_resolution_signal ADD FOREIGN KEY ("tenant", "signal") REFERENCES trust_signal ("tenant", "id");

ALTER TABLE vendor_delivery_signal ADD FOREIGN KEY ("tenant", "signal") REFERENCES trust_signal ("tenant", "id");
...
CREATE UNIQUE INDEX agent_run_signal_uq_signal ON agent_run_signal ("tenant", "signal");
CREATE UNIQUE INDEX device_subject_uq_serial ON device_subject ("tenant", "serial");
CREATE UNIQUE INDEX device_subject_uq_subject ON device_subject ("tenant", "subject");
CREATE UNIQUE INDEX marketplace_resolution_signal_uq_signal ON marketplace_resolution_signal ("tenant", "signal");
CREATE UNIQUE INDEX vendor_delivery_signal_uq_signal ON vendor_delivery_signal ("tenant", "signal");
