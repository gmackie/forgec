...
CREATE TABLE manufacturing_c_a_p_a (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "finding" TEXT COLLATE "C" NOT NULL,
...
CREATE TABLE model_assurance (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "finding" TEXT COLLATE "C" NOT NULL,
  "model_digest" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id")
);
...
CREATE TABLE vulnerability (
  ...
  "id" TEXT COLLATE "C" NOT NULL,
  "finding" TEXT COLLATE "C" NOT NULL,
  "advisory" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id")
);
...
ALTER TABLE access_review ADD FOREIGN KEY ("tenant", "finding") REFERENCES finding ("tenant", "id");

ALTER TABLE corrective_work ADD FOREIGN KEY ("tenant", "remediation") REFERENCES remediation ("tenant", "id");

ALTER TABLE manufacturing_c_a_p_a ADD FOREIGN KEY ("tenant", "finding") REFERENCES finding ("tenant", "id");

ALTER TABLE model_assurance ADD FOREIGN KEY ("tenant", "finding") REFERENCES finding ("tenant", "id");

ALTER TABLE vulnerability ADD FOREIGN KEY ("tenant", "finding") REFERENCES finding ("tenant", "id");
...
CREATE UNIQUE INDEX access_review_uq_finding ON access_review ("tenant", "finding");
CREATE UNIQUE INDEX manufacturing_c_a_p_a_uq_finding ON manufacturing_c_a_p_a ("tenant", "finding");
CREATE UNIQUE INDEX model_assurance_uq_finding ON model_assurance ("tenant", "finding");
CREATE UNIQUE INDEX vulnerability_uq_finding ON vulnerability ("tenant", "finding");
