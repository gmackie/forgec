...
CREATE TABLE facility_availability (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "facility_key" TEXT COLLATE "C" NOT NULL,
  "calendar" TEXT COLLATE "C" NOT NULL,
  "revision" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "calendar") REFERENCES availability_calendar ("tenant", "id"),
  FOREIGN KEY ("tenant", "revision") REFERENCES availability_calendar_revision ("tenant", "id")
);

CREATE TABLE machine_availability (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "machine_key" TEXT COLLATE "C" NOT NULL,
  "calendar" TEXT COLLATE "C" NOT NULL,
  "revision" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "calendar") REFERENCES availability_calendar ("tenant", "id"),
...
CREATE TABLE worker_availability (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "worker_key" TEXT COLLATE "C" NOT NULL,
  "calendar" TEXT COLLATE "C" NOT NULL,
  "revision" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "calendar") REFERENCES availability_calendar ("tenant", "id"),
