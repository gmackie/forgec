// Generated by forgec build from @fixture/attestation-consumer (contracts/1). Do not edit.
...
export const operations: Record<string, OperationSpec> = {
  ...
  "@fixture/attestation-consumer/_/changesets.propose": { method: "POST", path: "/v1/changesets", kind: "changeset.propose", resource: "changesets" },
  "@fixture/attestation-consumer/_/changesets.get": { method: "GET", path: "/v1/changesets/{id}", kind: "changeset.get", resource: "changesets" },
  "@fixture/attestation-consumer/_/changesets.preview": { method: "GET", path: "/v1/changesets/{id}/preview", kind: "changeset.preview", resource: "changesets" },
  "@fixture/attestation-consumer/_/changesets.approve": { method: "POST", path: "/v1/changesets/{id}/approve", kind: "changeset.approve", resource: "changesets" },
  "@fixture/attestation-consumer/_/changesets.commit": { method: "POST", path: "/v1/changesets/{id}/commit", kind: "changeset.commit", resource: "changesets" },
  "@fixture/attestation-consumer/_/admin.export": { method: "POST", path: "/v1/admin/export", kind: "admin.export", resource: "admin" },
  "@fixture/attestation-consumer/_/admin.import": { method: "POST", path: "/v1/admin/import", kind: "admin.import", resource: "admin" },
  "@fixture/attestation-consumer/_/admin.verify": { method: "POST", path: "/v1/admin/verify", kind: "admin.verify", resource: "admin" },
  "@fixture/attestation-consumer/_/admin.fence": { method: "POST", path: "/v1/admin/fence", kind: "admin.fence", resource: "admin" },
  "@fixture/attestation-consumer/_/admin.inspect": { method: "POST", path: "/v1/admin/inspect", kind: "admin.inspect", resource: "admin" },
  "@fixture/attestation-consumer/_/admin.subjects.locate": { method: "POST", path: "/v1/admin/subjects/locate", kind: "admin.subjects.locate", resource: "admin" },
  "@fixture/attestation-consumer/_/imports.inspect": { method: "POST", path: "/v1/imports/inspect", kind: "import.inspect", resource: "imports" },
  "@fixture/attestation-consumer/_/imports.stage": { method: "POST", path: "/v1/imports/stage", kind: "import.stage", resource: "imports" },
};

export interface ComplianceDeclarationRecord {
  id: string;
  assertion: string;
  regulation: string;
}

export interface ComplianceDeclarationCreate {
  assertion: string;
  regulation: string;
}

export interface ComplianceDeclarationPatch {
}

export interface CredentialAssertionRecord {
  id: string;
  assertion: string;
  credentialKey: string;
}

export interface CredentialAssertionCreate {
  assertion: string;
  credentialKey: string;
}

export interface CredentialAssertionPatch {
}

export interface SoftwareProvenanceRecord {
  id: string;
  assertion: string;
  subject: string;
}

export interface SoftwareProvenanceCreate {
  assertion: string;
  subject: string;
}

export interface SoftwareProvenancePatch {
}
...
export interface ComplianceDeclarationApi {
}

export interface CredentialAssertionApi {
}

export interface SoftwareProvenanceApi {
}
...
export interface ForgeClient {
  ...
  imports: ImportsApi;
  admin: AdminApi;
  complianceDeclarations: ComplianceDeclarationApi;
  credentialAssertions: CredentialAssertionApi;
  softwareProvenances: SoftwareProvenanceApi;
...
export function createClient(options: ClientOptions): ForgeClient {
  ...
  return {
    call: t.call,
    changesets: {
      propose: (input, opts) => t.unwrap(t.call("@fixture/attestation-consumer/_/changesets.propose", input, opts)),
      get: (id) => t.unwrap(t.call("@fixture/attestation-consumer/_/changesets.get", { id })),
      preview: (id) => t.unwrap(t.call("@fixture/attestation-consumer/_/changesets.preview", { id })),
      approve: (id, contentHash) => t.unwrap(t.call("@fixture/attestation-consumer/_/changesets.approve", { id, contentHash })),
      commit: (id, opts) => t.unwrap(t.call("@fixture/attestation-consumer/_/changesets.commit", { id }, opts)),
    },
    functions: {
    },
    imports: {
      inspect: (input) => t.unwrap(t.call("@fixture/attestation-consumer/_/imports.inspect", input)),
      stage: (input) => t.unwrap(t.call("@fixture/attestation-consumer/_/imports.stage", input)),
    },
    admin: {
      export: () => t.unwrap(t.call("@fixture/attestation-consumer/_/admin.export", {})),
      import: (snapshot) => t.unwrap(t.call("@fixture/attestation-consumer/_/admin.import", { snapshot })),
      verify: (snapshot) => t.unwrap(t.call("@fixture/attestation-consumer/_/admin.verify", { snapshot })),
      fence: (on) => t.unwrap(t.call("@fixture/attestation-consumer/_/admin.fence", { on })),
      locateSubject: (input) => t.unwrap(t.call("@fixture/attestation-consumer/_/admin.subjects.locate", input)),
      inspect: (input) => t.unwrap(t.call("@fixture/attestation-consumer/_/admin.inspect", input)),
    },
    views: {
    },
    projections: {
