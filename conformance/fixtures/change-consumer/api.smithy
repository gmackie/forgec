...
namespace fixture.change.consumer
...
structure PolicyChangeCreateInput {
    @required
    change: String
    @required
    policy: String
...
structure PolicyChangePatchInput {
}

structure RecipeChangeRecord {
    @required
    id: String
    @required
    change: String
...
structure RecipeChangeCreateInput {
    @required
    change: String
    @required
    recipe: String
...
structure RecipeChangePatchInput {
}

structure SoftwareDeploymentRecord {
    @required
    id: String
    @required
    change: String
...
structure SoftwareDeploymentCreateInput {
    @required
    change: String
    @required
    environment: String
...
structure SoftwareDeploymentPatchInput {
}
