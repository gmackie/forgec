...
namespace fixture.qualification.consumer
...
structure CredentialDetailsRecord {
    @required
    id: String
    @required
...
structure CredentialDetailsCreateInput {
    @required
    qualification: String
    @required
    credentialNumber: String
...
structure CredentialDetailsPatchInput {
}

structure RunnerRecord {
    @required
    id: String
    @required
    subject: String
...
structure RunnerPatchInput {
}

structure RunnerRequirementRecord {
    @required
    id: String
    @required
    requirement: String
...
structure RunnerRequirementCreateInput {
    @required
    requirement: String
    @required
    runtimeName: String
...
structure RunnerRequirementPatchInput {
}

structure TechnicianRecord {
    @required
    id: String
    @required
    person: String
...
structure TechnicianCreateInput {
    @required
    person: String
}

structure TechnicianPatchInput {
}

structure VendorRecord {
    @required
    id: String
    @required
    organization: String
...
structure VendorCreateInput {
    @required
    organization: String
}

structure VendorPatchInput {
}
