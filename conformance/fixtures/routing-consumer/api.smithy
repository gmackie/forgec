...
namespace foundation.probe.routing.consumers
...
structure ReviewerCreateInput {
    @required
    resource: String
}

structure ReviewerPatchInput {
    resource: String
}

structure SupportAgentRecord {
    @required
    id: String
    @required
    resource: String
...
structure SupportAgentCreateInput {
    @required
    resource: String
}

structure SupportAgentPatchInput {
    resource: String
}
