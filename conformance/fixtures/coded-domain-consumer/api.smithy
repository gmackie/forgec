...
namespace fixture.coded.domain.consumer
...
structure CountryAddressRecord {
    @required
    id: String
    @required
    country: String
...
structure CountryAddressCreateInput {
    @required
    country: String
    @required
    street: String
...
structure CountryAddressPatchInput {
}

structure CurrencyAmountRecord {
    @required
    id: String
    @required
    currency: String
...
structure CurrencyAmountCreateInput {
    @required
    currency: String
    @required
    minorUnits: Long
...
structure CurrencyAmountPatchInput {
}

structure IndustryRegistrationRecord {
    @required
    id: String
    @required
    industry: String
...
structure IndustryRegistrationCreateInput {
    @required
    industry: String
    @required
    businessName: String
...
structure IndustryRegistrationPatchInput {
}
...
structure CodePatchInput {
}

structure CodeDispositionRecord {
    @required
    id: String
    @required
    code: String
...
structure CodeDispositionCreateInput {
    @required
    code: String
    replacement: String
    replacementCode: String
...
structure CodeDispositionPatchInput {
}

structure CodeLabelRecord {
    @required
    id: String
    @required
    code: String
...
structure CodeLabelCreateInput {
    @required
    code: String
    @required
    locale: String
...
structure CodeLabelPatchInput {
}

structure CodeRevisionRecord {
    @required
    id: String
    @required
    code: String
...
structure CodeRevisionCreateInput {
    @required
    code: String
    @required
    release: String
...
structure CodeRevisionPatchInput {
}

structure CodedDomainRecord {
    @required
    id: String
    @required
    authority: String
...
structure CodedDomainCreateInput {
    @required
    authority: String
    @required
    context: String
...
structure CodedDomainPatchInput {
}

structure ConceptMappingRecord {
    @required
    id: String
    @required
    code: String
...
structure ConceptMappingCreateInput {
    @required
    code: String
    @required
    concept: String
...
structure ConceptMappingPatchInput {
}

structure DomainReleaseRecord {
    @required
    id: String
    @required
    domain: String
...
structure DomainReleaseCreateInput {
    @required
    domain: String
    @required
    version: String
...
structure DomainReleasePatchInput {
}

structure MappingRevisionRecord {
    @required
    id: String
    @required
    mapping: String
...
structure MappingRevisionCreateInput {
    @required
    mapping: String
    @required
    revision: Long
...
structure MappingRevisionPatchInput {
}

structure ReleaseWithdrawalRecord {
    @required
    id: String
    @required
    release: String
...
structure ReleaseWithdrawalCreateInput {
    @required
    release: String
    @required
    effectiveAt: String
...
structure ReleaseWithdrawalPatchInput {
}
