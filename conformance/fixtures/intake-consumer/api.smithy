...
namespace fixture.intake.consumer
...
structure ClinicalQuestionnaireRecord {
    @required
    id: String
    @required
    validation: String
...
structure ClinicalQuestionnaireCreateInput {
    @required
    validation: String
    @required
    temperatureC: String
...
structure ClinicalQuestionnairePatchInput {
}
...
structure ExpensePatchInput {
}

structure VendorApplicationRecord {
    @required
    id: String
    @required
    validation: String
...
structure VendorApplicationCreateInput {
    @required
    validation: String
    @required
    legalName: String
...
structure VendorApplicationPatchInput {
}
