...
CREATE UNIQUE INDEX cloud_asset_uq_asset ON cloud_asset ("tenant", "asset");
CREATE UNIQUE INDEX fleet_asset_uq_asset ON fleet_asset ("tenant", "asset");
CREATE UNIQUE INDEX industrial_asset_uq_asset ON industrial_asset ("tenant", "asset");
CREATE UNIQUE INDEX medical_asset_uq_asset ON medical_asset ("tenant", "asset");
