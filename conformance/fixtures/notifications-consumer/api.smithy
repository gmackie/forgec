...
namespace fixture.notifications.consumer
...
structure BobUpdateCreateInput {
    @required
    notification: String
    @required
    taskTitle: String
...
structure BobUpdatePatchInput {
}

structure ForgeGraphAlertRecord {
    @required
    id: String
    @required
    notification: String
...
structure ForgeGraphAlertCreateInput {
    @required
    notification: String
    @required
    deploymentName: String
...
structure ForgeGraphAlertPatchInput {
}

structure KanBangerNoticeRecord {
    @required
    id: String
    @required
    notification: String
...
structure KanBangerNoticeCreateInput {
    @required
    notification: String
    @required
    issueTitle: String
...
structure KanBangerNoticePatchInput {
}
