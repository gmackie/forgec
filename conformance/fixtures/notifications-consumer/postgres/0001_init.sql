...
CREATE TABLE bob_update (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "notification" TEXT COLLATE "C" NOT NULL,
  "task_title" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id")
);

CREATE TABLE forge_graph_alert (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "notification" TEXT COLLATE "C" NOT NULL,
...
CREATE TABLE kan_banger_notice (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "notification" TEXT COLLATE "C" NOT NULL,
  "issue_title" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id")
);
...
ALTER TABLE bob_update ADD FOREIGN KEY ("tenant", "notification") REFERENCES notification ("tenant", "id");

ALTER TABLE forge_graph_alert ADD FOREIGN KEY ("tenant", "notification") REFERENCES notification ("tenant", "id");

ALTER TABLE kan_banger_notice ADD FOREIGN KEY ("tenant", "notification") REFERENCES notification ("tenant", "id");
...
CREATE UNIQUE INDEX bob_update_uq_notification ON bob_update ("tenant", "notification");
CREATE UNIQUE INDEX forge_graph_alert_uq_notification ON forge_graph_alert ("tenant", "notification");
CREATE UNIQUE INDEX kan_banger_notice_uq_notification ON kan_banger_notice ("tenant", "notification");
