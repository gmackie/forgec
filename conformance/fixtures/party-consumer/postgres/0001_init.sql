...
CREATE TABLE customer (
  ...
  "id" TEXT COLLATE "C" NOT NULL,
  "party" TEXT COLLATE "C" NOT NULL,
  "customer_code" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "party") REFERENCES party ("tenant", "id")
);
...
CREATE TABLE worker (
  ...
  "worker_code" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "person") REFERENCES person ("tenant", "id")
);
...
CREATE UNIQUE INDEX customer_uq_customerCode ON customer ("tenant", "customer_code");
CREATE UNIQUE INDEX customer_uq_party ON customer ("tenant", "party");
CREATE UNIQUE INDEX organization_uq_party ON organization ("tenant", "party");
CREATE UNIQUE INDEX person_uq_party ON person ("tenant", "party");
CREATE UNIQUE INDEX worker_uq_workerCode ON worker ("tenant", "worker_code");
