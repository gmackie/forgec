...
namespace fixture.resource.relations.consumer
...
structure CloudResourceCreateInput {
    @required
    resource: String
    @required
    account: String
...
structure CloudResourcePatchInput {
}

structure ConsignedInventoryRecord {
    @required
    id: String
    @required
    resource: String
...
structure ConsignedInventoryCreateInput {
    @required
    resource: String
    @required
    lot: String
...
structure ConsignedInventoryPatchInput {
}

structure CustodyHandoffEventRecord {
    @required
    id: String
    @required
    source: String
...
structure CustodyHandoffEventCreateInput {
    @required
    source: String
    @required
    resource: String
...
structure CustodyHandoffEventPatchInput {
}

structure LeasedEquipmentRecord {
    @required
    id: String
    @required
    resource: String
...
structure LeasedEquipmentCreateInput {
    @required
    resource: String
    @required
    serial: String
...
structure LeasedEquipmentPatchInput {
}
