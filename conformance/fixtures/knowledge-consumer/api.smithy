...
namespace fixture.knowledge.consumer
...
structure StandardOperatingProcedureRecord {
    @required
    id: String
    @required
...
structure StandardOperatingProcedureCreateInput {
    @required
    procedureCode: String
    @required
    edition: String
...
structure StandardOperatingProcedurePatchInput {
}

structure SupportArticleRecord {
    @required
    id: String
    @required
    product: String
...
structure SupportArticleCreateInput {
    @required
    product: String
    @required
    edition: String
...
structure SupportArticlePatchInput {
}

structure TrainingMaterialRecord {
    @required
    id: String
    @required
    courseCode: String
...
structure TrainingMaterialCreateInput {
    @required
    courseCode: String
    @required
    edition: String
...
structure TrainingMaterialPatchInput {
}
...
structure KnowledgeClassificationRecord {
    @required
    id: String
    @required
    assignment: String
...
structure KnowledgeClassificationCreateInput {
    @required
    assignment: String
    next: String
    @required
...
structure KnowledgeClassificationPatchInput {
}

structure KnowledgeFeedbackRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure KnowledgeFeedbackCreateInput {
    @required
    edition: String
    @required
    revision: String
...
structure KnowledgeFeedbackPatchInput {
}

structure KnowledgeFeedbackResultRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure KnowledgeFeedbackResultCreateInput {
    @required
    feedback: String
    @required
    finish: String
...
structure KnowledgeFeedbackResultPatchInput {
}

structure KnowledgeItemRecord {
    @required
    id: String
    @required
    key: String
...
structure KnowledgeItemCreateInput {
    @required
    key: String
    @required
    title: String
...
structure KnowledgeItemPatchInput {
}

structure KnowledgePublicationRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure KnowledgePublicationCreateInput {
    @required
    revision: String
    @required
    release: String
...
structure KnowledgePublicationPatchInput {
}

structure KnowledgeRevisionRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure KnowledgeRevisionCreateInput {
    @required
    item: String
    @required
    revision: Long
...
structure KnowledgeRevisionPatchInput {
}
...
structure CandidateEvaluationRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure CandidateEvaluationCreateInput {
    @required
    candidate: String
    @required
    run: String
...
structure CandidateEvaluationPatchInput {
}

structure CandidateQualificationRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure CandidateQualificationCreateInput {
    @required
    candidate: String
    @required
    policy: String
...
structure CandidateQualificationPatchInput {
}

structure PromotionRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure PromotionCreateInput {
    @required
    series: String
    @required
    ordinal: Long
...
structure PromotionPatchInput {
}

structure PublicationChannelRecord {
    @required
    id: String
    @required
    series: String
...
structure PublicationChannelCreateInput {
    @required
    series: String
    @required
    name: String
...
structure PublicationChannelPatchInput {
}

structure PublicationSeriesRecord {
    @required
    id: String
    @required
    key: String
...
structure PublicationSeriesCreateInput {
    @required
    key: String
    @required
    label: String
...
structure PublicationSeriesPatchInput {
}

structure ReleaseRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure ReleasePatchInput {
}

structure ReleaseAudienceLinkRecord {
    @required
    id: String
    @required
    promotion: String
...
structure ReleaseAudienceLinkCreateInput {
    @required
    promotion: String
    @required
    release: String
...
structure ReleaseAudienceLinkPatchInput {
}

structure ReleaseCandidateRecord {
    @required
    id: String
    @required
    createdAt: String
...
structure ReleaseCandidateCreateInput {
    @required
    series: String
    @required
    version: String
...
structure ReleaseCandidatePatchInput {
}
