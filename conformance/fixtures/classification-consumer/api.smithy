...
namespace foundation.probe.classification.consumers
...
structure JobFamilyCreateInput {
    @required
    classifications: String
}

structure JobFamilyPatchInput {
}

structure KnowledgeArticleRecord {
    @required
    id: String
    @required
    classifications: String
...
structure KnowledgeArticleCreateInput {
    @required
    classifications: String
}

structure KnowledgeArticlePatchInput {
}
...
structure ProductCreateInput {
    @required
    classifications: String
}

structure ProductPatchInput {
}

structure RiskScenarioRecord {
    @required
    id: String
    @required
    classifications: String
...
structure RiskScenarioCreateInput {
    @required
    classifications: String
}

structure RiskScenarioPatchInput {
}
