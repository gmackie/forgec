// Generated by forgec build from @foundation-probe/classification-consumers (contracts/1). Do not edit.
...
export const operations: Record<string, OperationSpec> = {
  "@foundation-probe/classification-consumers/_/changesets.propose": { method: "POST", path: "/v1/changesets", kind: "changeset.propose", resource: "changesets" },
  "@foundation-probe/classification-consumers/_/changesets.get": { method: "GET", path: "/v1/changesets/{id}", kind: "changeset.get", resource: "changesets" },
  "@foundation-probe/classification-consumers/_/changesets.preview": { method: "GET", path: "/v1/changesets/{id}/preview", kind: "changeset.preview", resource: "changesets" },
  "@foundation-probe/classification-consumers/_/changesets.approve": { method: "POST", path: "/v1/changesets/{id}/approve", kind: "changeset.approve", resource: "changesets" },
  "@foundation-probe/classification-consumers/_/changesets.commit": { method: "POST", path: "/v1/changesets/{id}/commit", kind: "changeset.commit", resource: "changesets" },
  "@foundation-probe/classification-consumers/_/admin.export": { method: "POST", path: "/v1/admin/export", kind: "admin.export", resource: "admin" },
  "@foundation-probe/classification-consumers/_/admin.import": { method: "POST", path: "/v1/admin/import", kind: "admin.import", resource: "admin" },
  "@foundation-probe/classification-consumers/_/admin.verify": { method: "POST", path: "/v1/admin/verify", kind: "admin.verify", resource: "admin" },
  "@foundation-probe/classification-consumers/_/admin.fence": { method: "POST", path: "/v1/admin/fence", kind: "admin.fence", resource: "admin" },
  "@foundation-probe/classification-consumers/_/admin.inspect": { method: "POST", path: "/v1/admin/inspect", kind: "admin.inspect", resource: "admin" },
  "@foundation-probe/classification-consumers/_/admin.subjects.locate": { method: "POST", path: "/v1/admin/subjects/locate", kind: "admin.subjects.locate", resource: "admin" },
  "@foundation-probe/classification-consumers/_/imports.inspect": { method: "POST", path: "/v1/imports/inspect", kind: "import.inspect", resource: "imports" },
  "@foundation-probe/classification-consumers/_/imports.stage": { method: "POST", path: "/v1/imports/stage", kind: "import.stage", resource: "imports" },
};
...
export interface JobFamilyRecord {
  id: string;
  classifications: string;
}

export interface JobFamilyCreate {
  classifications: string;
}

export interface JobFamilyPatch {
}
...
export interface KnowledgeArticlePatch {
}
...
export interface RiskScenarioRecord {
  id: string;
  classifications: string;
}
...
export interface RiskScenarioPatch {
}
...
export interface RiskScenarioApi {
}
...
export interface ForgeClient {
  ...
  issuers: IssuerApi;
  jobFamilys: JobFamilyApi;
  knowledgeArticles: KnowledgeArticleApi;
  products: ProductApi;
  riskScenarios: RiskScenarioApi;
  views: {
  };
  projections: {
  };
...
export function createClient(options: ClientOptions): ForgeClient {
  ...
  return {
    call: t.call,
    changesets: {
      propose: (input, opts) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/changesets.propose", input, opts)),
      get: (id) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/changesets.get", { id })),
      preview: (id) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/changesets.preview", { id })),
      approve: (id, contentHash) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/changesets.approve", { id, contentHash })),
      commit: (id, opts) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/changesets.commit", { id }, opts)),
    },
    functions: {
    },
    imports: {
      inspect: (input) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/imports.inspect", input)),
      stage: (input) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/imports.stage", input)),
    },
    admin: {
      export: () => t.unwrap(t.call("@foundation-probe/classification-consumers/_/admin.export", {})),
      import: (snapshot) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/admin.import", { snapshot })),
      verify: (snapshot) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/admin.verify", { snapshot })),
      fence: (on) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/admin.fence", { on })),
      locateSubject: (input) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/admin.subjects.locate", input)),
      inspect: (input) => t.unwrap(t.call("@foundation-probe/classification-consumers/_/admin.inspect", input)),
    },
    views: {
    },
    projections: {
