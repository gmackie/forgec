...
namespace foundation.probe.allocation.consumers
...
structure HospitalBedCreateInput {
    @required
    capacity: String
}

structure HospitalBedPatchInput {
}
...
structure RunnerGpuCreateInput {
    @required
    capacity: String
}

structure RunnerGpuPatchInput {
}
