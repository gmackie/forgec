...
namespace foundation.probe.artifact.consumers
...
structure BuildOutputCreateInput {
    @required
    revision: String
    @required
    buildHash: String
...
structure BuildOutputPatchInput {
}

structure DocumentRecord {
    @required
    id: String
    @required
    revision: String
...
structure DocumentPatchInput {
}

structure EvidenceDocumentRecord {
    @required
    id: String
    @required
    revision: String
...
structure EvidenceDocumentCreateInput {
    @required
    revision: String
    @required
    observation: String
...
structure EvidenceDocumentPatchInput {
}

structure GeneratedAssetRecord {
    @required
    id: String
    @required
    revision: String
...
structure GeneratedAssetCreateInput {
    @required
    revision: String
    @required
    generator: String
...
structure GeneratedAssetPatchInput {
}
