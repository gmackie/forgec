...
CREATE TABLE organization_unit (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "organization" TEXT COLLATE "C" NOT NULL,
  "parent" TEXT COLLATE "C",
  ...
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "organization") REFERENCES party ("tenant", "id"),
  FOREIGN KEY ("tenant", "parent") REFERENCES organization_unit ("tenant", "id"),
...
CREATE TABLE position_specification (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "pin" TEXT COLLATE "C" NOT NULL,
...
CREATE TABLE position (
  ...
  "label" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "unit") REFERENCES organization_unit ("tenant", "id"),
  FOREIGN KEY ("tenant", "specification") REFERENCES position_specification ("tenant", "id"),
...
CREATE TABLE employee_position (
  ...
  "label" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "position") REFERENCES position ("tenant", "id")
);

CREATE TABLE incident_command_position (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "position" TEXT COLLATE "C" NOT NULL,
  "label" TEXT COLLATE "C" NOT NULL,
...
CREATE TABLE production_crew_position (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "position" TEXT COLLATE "C" NOT NULL,
  "label" TEXT COLLATE "C" NOT NULL,
...
CREATE TABLE incumbency (
  ...
  "party_subject" TEXT COLLATE "C" NOT NULL,
  ...
  FOREIGN KEY ("tenant", "party_subject") REFERENCES party_subject ("tenant", "id")
);

CREATE TABLE incumbency_event (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "position" TEXT COLLATE "C" NOT NULL,
  "ordinal" BIGINT NOT NULL,
  "previous" TEXT COLLATE "C",
  "incumbency" TEXT COLLATE "C" NOT NULL,
  "action" TEXT COLLATE "C" NOT NULL,
  "at" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "position") REFERENCES position ("tenant", "id"),
  FOREIGN KEY ("tenant", "previous") REFERENCES incumbency_event ("tenant", "id"),
  FOREIGN KEY ("tenant", "incumbency") REFERENCES incumbency ("tenant", "id")
);
...
CREATE UNIQUE INDEX employee_position_uq_position ON employee_position ("tenant", "position");
CREATE UNIQUE INDEX incident_command_position_uq_position ON incident_command_position ("tenant", "position");
CREATE UNIQUE INDEX production_crew_position_uq_position ON production_crew_position ("tenant", "position");
...
CREATE UNIQUE INDEX incumbency_event_uq_position_ordinal ON incumbency_event ("tenant", "position", "ordinal");
CREATE INDEX incumbency_event_ix_by_position ON incumbency_event ("tenant", "position", "ordinal", "id");
