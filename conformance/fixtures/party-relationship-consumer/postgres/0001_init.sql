...
CREATE TABLE corporate_ownership (
  ...
  "ownership_percent" BIGINT NOT NULL,
  PRIMARY KEY ("tenant", "id"),
...
CREATE TABLE employment (
  ...
  "valid_until" TEXT COLLATE "C",
  "definition" TEXT COLLATE "C" NOT NULL,
  "job_title" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "from_party") REFERENCES party ("tenant", "id"),
  FOREIGN KEY ("tenant", "to_party") REFERENCES party ("tenant", "id"),
  FOREIGN KEY ("tenant", "definition") REFERENCES party_relationship_definition ("tenant", "id")
...
CREATE TABLE guardianship (
  ...
  "valid_until" TEXT COLLATE "C",
  "definition" TEXT COLLATE "C" NOT NULL,
  "court_order" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "from_party") REFERENCES party ("tenant", "id"),
  FOREIGN KEY ("tenant", "to_party") REFERENCES party ("tenant", "id"),
  FOREIGN KEY ("tenant", "definition") REFERENCES party_relationship_definition ("tenant", "id")
...
CREATE TABLE supply_relationship (
  ...
  "valid_until" TEXT COLLATE "C",
  "definition" TEXT COLLATE "C" NOT NULL,
  "supplier_number" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id"),
  FOREIGN KEY ("tenant", "from_party") REFERENCES party ("tenant", "id"),
  FOREIGN KEY ("tenant", "to_party") REFERENCES party ("tenant", "id"),
  FOREIGN KEY ("tenant", "definition") REFERENCES party_relationship_definition ("tenant", "id")
...
ALTER TABLE corporate_ownership ADD FOREIGN KEY ("tenant", "relationship") REFERENCES party_relationship ("tenant", "id");

ALTER TABLE employment ADD FOREIGN KEY ("tenant", "relationship") REFERENCES party_relationship ("tenant", "id");

ALTER TABLE guardianship ADD FOREIGN KEY ("tenant", "relationship") REFERENCES party_relationship ("tenant", "id");

ALTER TABLE supply_relationship ADD FOREIGN KEY ("tenant", "relationship") REFERENCES party_relationship ("tenant", "id");
