...
namespace foundation.probe.scheduling.consumers
...
structure ClassroomBookingRecord {
    @required
    id: String
    @required
    appointment: String
...
structure ClassroomBookingCreateInput {
    @required
    appointment: String
}

structure ClassroomBookingPatchInput {
    appointment: String
}

structure FieldVisitRecord {
    @required
    id: String
    @required
    appointment: String
...
structure FieldVisitCreateInput {
    @required
    appointment: String
}

structure FieldVisitPatchInput {
    appointment: String
}

structure LabBookingRecord {
    @required
    id: String
    @required
    appointment: String
...
structure LabBookingCreateInput {
    @required
    appointment: String
}

structure LabBookingPatchInput {
    appointment: String
}
