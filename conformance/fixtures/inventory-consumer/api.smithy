...
namespace fixture.inventory.consumer
...
structure ClinicalStockCreateInput {
    @required
    item: String
    @required
    product: String
...
structure ClinicalStockPatchInput {
}

structure ITStockRecord {
    @required
    id: String
    @required
    item: String
...
structure ITStockPatchInput {
}

structure ManufacturingStockRecord {
    @required
    id: String
    @required
    item: String
...
structure ManufacturingStockCreateInput {
    @required
    item: String
    @required
    material: String
...
structure ManufacturingStockPatchInput {
}

structure VisibilityEventRecord {
    @required
    id: String
    @required
    visibility: String
    @required
    epcisReference: String
}

structure VisibilityEventCreateInput {
    @required
    visibility: String
    @required
    epcisReference: String
...
structure VisibilityEventPatchInput {
}

structure WarehouseStockRecord {
    @required
    id: String
    @required
    item: String
...
structure WarehouseStockCreateInput {
    @required
    item: String
    @required
    sku: String
...
structure WarehouseStockPatchInput {
}
