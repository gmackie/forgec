...
CREATE TABLE manufacturing_performance (
  "tenant" TEXT COLLATE "C" NOT NULL,
  "id" TEXT COLLATE "C" NOT NULL,
  "observation" TEXT COLLATE "C" NOT NULL,
  "indicator" TEXT COLLATE "C" NOT NULL,
  PRIMARY KEY ("tenant", "id")
);
...
ALTER TABLE agent_performance ADD FOREIGN KEY ("tenant", "observation") REFERENCES metric_observation ("tenant", "id");

ALTER TABLE clinical_performance ADD FOREIGN KEY ("tenant", "observation") REFERENCES metric_observation ("tenant", "id");

ALTER TABLE manufacturing_performance ADD FOREIGN KEY ("tenant", "observation") REFERENCES metric_observation ("tenant", "id");

ALTER TABLE service_performance ADD FOREIGN KEY ("tenant", "observation") REFERENCES metric_observation ("tenant", "id");
...
CREATE UNIQUE INDEX agent_performance_uq_observation ON agent_performance ("tenant", "observation");
CREATE UNIQUE INDEX clinical_performance_uq_observation ON clinical_performance ("tenant", "observation");
CREATE UNIQUE INDEX manufacturing_performance_uq_observation ON manufacturing_performance ("tenant", "observation");
CREATE UNIQUE INDEX service_performance_uq_observation ON service_performance ("tenant", "observation");
