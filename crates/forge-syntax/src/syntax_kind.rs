...
pub enum SyntaxKind {
    ...
    RESOURCE_DECL, BLOB_DECL, CACHE_DECL, VIEW_DECL, PROJECTION_DECL, FUNCTION_DECL, CHANNEL_DECL, SOURCE_DECL, SUBSCRIPTION_DECL,
    KEY_DECL, LOADER_DECL, FRESH_DECL, FROM_DECL, WHERE_DECL, BY_DECL, FIELDS_DECL, AGGREGATE_DECL,
    ...
    WORKFLOW_DECL, WORKFLOW_VERSION, STEP_DECL, STEP_CALL, STEP_SLEEP, STEP_WAIT, CATCH_CLAUSE, CORRELATE_CLAUSE, TIMEOUT_CLAUSE,
    CHOICE_DECL, THEN_BLOCK, ELSE_BLOCK, PARALLEL_DECL, RETURN_DECL, FAIL_DECL, NAMED_ARG,
    PURPOSE_DECL, DATA_CLASS_DECL, EXTENDS_CLAUSE, CAPABILITY_DECL, CAPABILITY_ITEM, NAME_SET, PURPOSE_BINDING, USE_PURPOSE, FUNCTION_PURPOSE,
