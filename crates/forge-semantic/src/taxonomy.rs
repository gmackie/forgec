...
//!
//! The embedded copy lives beside this crate (`crates/forge-semantic/taxonomy.json`)
...
mod mirror {
    ...
    fn taxonomy_mirror_matches_the_contract() {
        ...
        assert_eq!(
            authority,
            super::TAXONOMY_JSON,
            "crates/forge-semantic/taxonomy.json has drifted from {}; copy the contract over it",
            contract.display()
        );
    }
}
