// The Acme management workspace: the generic @forgegraph/react workspace driven by
...
import { Workspace } from "@forgegraph/react";
import { createClient } from "../generated/client";
import bundle from "../generated/app.json";

const params = new URLSearchParams(location.search);
const baseUrl = params.get("api") ?? "http://localhost:8787";
