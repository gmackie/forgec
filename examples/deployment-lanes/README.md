...
The checked-in runtime fixture under `conformance/fixtures/deployment-lanes` is generated from this package. Runtime tests exercise concurrent create attempts, tenant isolation, lifecycle release, matching-to-matching transitions and key changes using memory and actual SQLite through the SQL adapter. Live Postgres and DynamoDB certification still requires their integration harnesses.
