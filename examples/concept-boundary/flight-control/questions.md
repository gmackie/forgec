...
- Does changing the 10000 us period or 5000 us deadline change admissible behavior? Yes: therefore these are proposed L0 requirements, although timer and scheduler mechanisms remain L1/L2.
...
- Where does the model stop? Sensor-fusion equations, stability margins, actuator dynamics, synchronous control-law causality and voting failure assumptions. Matching ports cannot import those execution or physical laws.
